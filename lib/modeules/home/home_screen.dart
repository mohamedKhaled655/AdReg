...
import 'package:advising_academy/shared/network/local/cache_Helper.dart';
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<StudentInfoCubit, StudentInfoStates>(
        listener: (BuildContext context, state) {
          ...
          if(StudentInfoCubit.get(context).studentInfoModel.status==false||StudentInfoCubit.get(context).studentInfoModel==null){
          ...
          return RefreshIndicator(
            child: Scaffold(
              ...
              body: ConditionalBuilder(
                ...
                fallback: (context) => Center(child: SplashScreen()),
              ),
            ),
            onRefresh: StudentInfoCubit.get(context).loadResources,
